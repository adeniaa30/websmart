          ...
          <div class="col-md-4">
              ...
              <select name="lab" id="lab" class="form-control">
                <option disable selected>Pilih Laboratorium</option>
                    ...
                    <option value="{{ $nama_lab }}" {{ request('lab') == '$nama_lab' ? 'selected' : ''}}>{{ $nama_lab }}</option>
                    @endforeach
                  <!-- Add more options for other labs -->
              </select>
          </div>
          <div class="col-md-4">
    ...
    <div class="row">
      <div class="col-lg-4 mb-4"> <!-- Adjust column width as needed (e.g., col-lg-4, col-md-6, etc.) -->
        <div class="card h-100">
          <img src="{{ asset('storage/LOGO INFRATEK.png') }}" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      {{-- <div class="col-lg-4 mb-4">
        <div class="card h-100">
          <img src="{{ asset('storage/LOGO INFRATEK.png') }}" class="card-img-top" alt="logo infratek">
          <div class="card-body">
